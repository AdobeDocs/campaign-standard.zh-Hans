...
* 利用&#x200B;**[!UICONTROL Create an In-App message]**&#x200B;卡，可使用应用程序内创建助手。 利用此助手，可选择要创建的应用程序内消息类型、定义其属性、受众和内容。 请参阅[创建应用程序内消息](../../channels/using/about-in-app-messaging.md)一节。
...
* 通过&#x200B;**解决方案切换器**&#x200B;图标，您可以在组织之间切换，或切换到其他应用程序。
* **[!UICONTROL Help]**&#x200B;图标在](#help)下方有描述。[
