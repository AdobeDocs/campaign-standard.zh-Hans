...
您还可以观看此[介绍视频](https://video.tv.adobe.com/v/330104/?captions=chi_hans&autoplay=true&hidetitle=true)。
...
1. 拖放塑造电子邮件所需的结构组件。
   ...
   >[!NOTE]
   >
   >请注意，并非所有电子邮件程序都与列栈叠兼容。 当不支持时，将不会栈叠列。
   >
...
>[!NOTE]
>
>请注意，并非所有电子邮件程序都与邮件引文兼容。 当不支持时，将不显示预编译标头。
...
>title="轮播设置"
>abstract="了解如何在您的内容中插入并配置轮播。请注意，并非所有电子邮件客户端都支持轮播，在不支持的情况下会显示备用图像。"
