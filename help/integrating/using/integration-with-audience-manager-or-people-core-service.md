...
description: 了解如何配置Audience Manager/People核心服务集成，以便开始与其他Adobe Experience Cloud解决方案共享受众或区段。
...
在Adobe Campaign中配置和配置Audience Manager与People核心需要两个步骤：[将请求提交到Adobe](#submitting-request-to-adobe)，然后[在Adobe Campaign中配置集成](#configuring-the-integration-in-adobe-campaign)。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 示例：Adobe Audience Manager。 无论您是否拥有Audience Manager许可证，务必要向配置团队提及。</td> 
  </tr> 
  <tr> 
...
提交此请求后，Adobe将继续为您配置集成，并联系您以提供完成配置所需的详细信息和信息：
...
我们首先需要在Adobe Campaign中配置或检查外部帐户。 这些帐户应该由Adobe配置，并且应该已经向您传达了必要的信息。
...
* **声明的ID**&#x200B;数据源：需要使用Audience Manager中的&#x200B;**[!UICONTROL DeclaredId]**&#x200B;数据源定义创建并映射此数据源。
...
1. 在&#x200B;**[!UICONTROL Data Source/ Alias]**&#x200B;下拉列表中，选择与Audience Manager中&#x200B;**[!UICONTROL DeclaredID]**&#x200B;数据源对应的数据Source。
