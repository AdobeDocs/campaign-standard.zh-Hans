...
您只能使用标准投放对兴趣点数据做出反应。 [事务](../../channels/using/getting-started-with-transactional-msg.md) 消息不能使用位置数据。
...
1. 定义投放的受众时，将&#x200B;**[!UICONTROL Subscriptions to an application]**&#x200B;元素拖放到工作区中。
   ...
   管理受众详见[定义受众](../../audiences/using/creating-audiences.md)部分。
...
1. 在&#x200B;**[!UICONTROL Add a rule - POI Location Subscription]**&#x200B;窗口中，输入要使用的兴趣点标签。
