...
用户在Admin Console中进行管理。 在[管理组和用户](../../administration/using/managing-groups-and-users.md)部分以及[Admin Console文档](https://helpx.adobe.com/cn/enterprise/managing/user-guide.html)中了解详情。
