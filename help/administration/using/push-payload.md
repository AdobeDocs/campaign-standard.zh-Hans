...
从Adobe Campaign发送到iOS应用程序的&#x200B;**示例有效负载：**
...
要与[iOS APNS Tester](https://pushtry.com/)**一起使用的** JSON示例有效负载
...
### 适用于Android应用程序的 {#payload-structure-android}
...
**使用[Google FCM测试器](https://pushtry.com/)的JSON示例有效负载**
...
>[!NOTE]
>
>自2018年1月起，Android有效负载中删除了对“通知”消息的支持，以便能够唤醒应用程序并将控制权传递到移动应用程序，而无需用户与应用程序交互。
...
* iOS应用程序： **正在处理[远程通知](https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/HandlingRemoteNotifications.html)中的远程通知**&#x200B;节。
