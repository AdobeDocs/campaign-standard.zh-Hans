...
1. 输入用户档案数据。
   ...
   * 此 **[!UICONTROL Access authorization]** 类别指示要执行的用户档案的组织单位 [管理权限](../../administration/using/about-access-management.md). 要向用户档案添加组织字段，请参阅[划分用户档案](../../administration/using/organizational-units.md#partitioning-profiles)一节。
