...
1. 输入用户档案数据。
   ...
   * 此 **[!UICONTROL Access authorization]** 類別會指出設定檔的組織單位 [管理許可權](../../administration/using/about-access-management.md). 要向用户档案添加组织字段，请参阅[划分用户档案](../../administration/using/organizational-units.md#partitioning-profiles)一节。
