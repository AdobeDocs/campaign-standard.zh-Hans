...
在受众列表中，您可以通过对 Adobe Campaign 轮廓执行查询创建受众，也可通过导入 Adobe Experience Cloud 受众以创建受众。
...
1. 然后，选择您要用于筛选客户的 **[!UICONTROL Targeting dimension]**。 每个受众由单个定向维度组成。 例如，不能创建同时包含轮廓、测试轮廓和订阅者的受众。 有关定向维度的更多信息，请参阅[此页面](../../automating/using/query.md#targeting-dimensions-and-resources)。
...
与从 Adobe Campaign 查询轮廓的&#x200B;**查询**&#x200B;类型受众不同，**Experience Cloud** 受众由一系列“访客 ID”组成。
...
1. 在 **[!UICONTROL Expires on]** 字段中，为该受众添加过期日期。

   ![](assets/audience_delete_3.png)

1. 单击 **[!UICONTROL Confirm]**，然后单击 **[!UICONTROL Save]**。

过期日期配置完成。 一旦达到此日期，该受众将自动删除。
