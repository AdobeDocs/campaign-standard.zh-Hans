...
使用Adobe Campaign通过一组来创建和管理新闻稿和跨渠道通信 **服务**：消息仅发送给订阅了服务（选择加入）的用户档案。 创建消息时，会使用专用过滤器标识这些用户档案。
...
1. **监测订阅**  — 发现多种监测服务订阅的方法 [在此部分中](../../audiences/using/monitoring-subscriptions.md)
