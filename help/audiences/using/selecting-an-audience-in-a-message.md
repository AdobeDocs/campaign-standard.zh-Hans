...
1. 定义电子邮件的主 **[!UICONTROL Target]**。这是电子邮件的常规目标受众。
   ...
   >[!NOTE]
   >
   >定位受众时，请注意，未引用受众的定义，但 **已复制** 放入查询中。 如果在查询中定位受众后对该受众进行了任何更改，请确保再次配置查询以将新定义考虑在内。
...
1. 如果需要，可以使用相应的选项卡定义控制组。 这样，您就可以从目标中撤销一些用户档案，以便这些用户档案不会收到消息。 有关此内容的更多信息，请参阅 [添加控制组](../../sending/using/control-group.md).
