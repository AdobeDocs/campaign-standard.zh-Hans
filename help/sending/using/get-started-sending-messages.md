...
最后，利用Campaign Standard中提供的可投放性准则和工具来增加已投放消息的数量，并确保营销活动取得成功。
...
Campaign Standard提供了多种&#x200B;**可投放性工具**&#x200B;来帮助您改善成功投放的邮件数：投放吞吐量报告、发送时间优化、邮件预览、电子邮件渲染、隔离管理等。
...
本视频说明如何在Campaign Standard中发送测试电子邮件、准备然后发送电子邮件投放。
