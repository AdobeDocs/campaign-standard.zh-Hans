...
* 修复了显示和筛选营销活动时的界面问题。
* 修复了阻止订阅日期字段通过POST Rest API调用进行更新的问题。
...
* 配置推送通知渠道时，iOS的推送提供程序平台应 **为apns** ,Android **gcm**。
...
* 修复了活动中 **[!UICONTROL Load file]** 的一个问题，该问题可能导致手动添加和删除活动中的列后出错。
* 现 **[!UICONTROL deliverabilityUpdate]** 在，技术工作流计划在服务器时间凌晨2点运行。
...
* 修复了允许任何用户导出列表的问题。 现在，仅允许具有该 **[!UICONTROL Export]** 角色的用户访问。

_电子邮件、短信和直邮_

* 修复了updateDeliveryExecInfo工 **作流程中** ，该工作流程将SMS投放 **的“传送** ”指示符设置为0的问题。
* 在投放模板 **属性的** “高级参数”中 **,“路由”下拉式列表** 现在仅显示与模板消息类型对应的外部帐户。 例如，电子邮件投放模板仅显示电子邮件外部帐户。
...
* 在顶部栏中，链 **[!UICONTROL Timeline]** 接已被删除，并替换为指向的链接 **[!UICONTROL Programs & Campaigns]** 。

_电子邮件和短信_

* 修复了投放状态显示错误颜色的 **[!UICONTROL Retry in progress]** 问题。 颜色是灰色而不是蓝色。

_工作流_

* 修复了将操作更改为在活动中执行时发生的 **[!UICONTROL Transfer file]** 问题。

_报告_

* 已 **[!UICONTROL Spam]** 更改 **[!UICONTROL Spam rate]** 了计算和指标。
* 已 **[!UICONTROL Bounce]** 经改进指标，以获得更准确的结果。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 您现在可以访问以Creative SDK为后盾的一整套功能，在编辑电子邮件或登陆页时直接在内容编辑器中增强您的图像。<br /> 此功能不需要购买其他Creative Cloud解决方案。<br /> 有关详细信息，请参阅详 <a href="../../designing/using/images.md#modifying-images-with-the-adobe-creative-sdk">细文档</a>。<br /> </td> 
  </tr> 
  <tr> 
   <td> 交易推送通知<br /> </td> 
  ...
  <tr> 
   ...
   <td> Amazon Simple存储服务(S3)连接器现在可用于将数据导入或导出到Adobe Campaign。 可以在工作流活动中设置。 配置在外部帐户中完成。<br /> 有关详细信息，请参阅详 <a href="../../administration/using/external-accounts.md">细文档</a>。<br /> </td> 
  </tr> 
  <tr> 
   <td> Dreamweaver实时集成<br /> </td> 
   <td> Adobe Campaign与Dreamweaver之间的集成现已实现。 它现在可与Dreamweaver(17.0.2)的最新正式发布版本配合使用。<br /> 这需要从以下位置安装Adobe Campaign集成扩展： <a href="https://adobe.ly/acdw_addon">https://adobe.ly/acdw_addon</a><br /> 有关详细信息，请参阅此 <a href="https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/designing-content/email-designer/dreamweaver-integration.html">视频</a>。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
* 我们优化了登陆页中 **[!UICONTROL by email]** 使用的过滤器，使新订阅者与数据库用户档案保持一致。
* 修复了在表单配置中使用布尔字段时显示自由文本输入而非复选框的问题。
* 修复了无法生成登陆页缩略图的问题。

_工作流_

* 修复了编辑或活动时 **[!UICONTROL End]** 的显 **[!UICONTROL External Signal]** 示错误（仅在Safari上）。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 通过Adobe Campaign和Dreamweaver的集成，您现在可以通过Adobe解决方案创建电子邮件活动的集成流程。<br /> 您可以在Dreamweaver中编辑Adobe Campaign电子邮件，并使内容在两个解决方案之间无缝同步。<br /> 对于初始版本，该集成可作为“实验室”功能提供，并且仅与Dreamweaver预发行版测试版一起使用。 如果要激活它，请联系AC-DW-integration@adobe.com。<br /> 有关详细信息，请参阅此 <a href="https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/designing-content/email-designer/dreamweaver-integration.html">视频</a>。<br /> </td> 
  </tr> 
  <tr> 
   <td> 手动发送时间优化<br /> </td> 
  ...
  <tr> 
   <td> 工作流: 新信号活动<br /> </td> 
   <td> 使用新的信号活动从另一个工作流触 <span class="uicontrol">发工作流</span> 。<br /> 利用从另一个工作流开始一个工作流的能力，您现在可以支持更复杂的客户旅程。 您可以更好地监控客户旅程，并在出现问题时做出反应。<br /> 已更新多个工作流活动:<br /> 
    <ul> 
...
* 修复了导致选项保 **[!UICONTROL Request confirmation before sending messages]** 持选中状态的问题，即使在取消选中并保存投放后也是如此。
...
* 修复了可能无法读取活动拒绝过渡内容的问 **[!UICONTROL Load file]** 题。
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 为外部报告导出日志<br /> </td> 
   <td> 导出投放和跟踪日志等日志，在您喜欢的报告或BI工具中处理它们。 您可以使用简单的工作流和增量查询自动定期导出新日志。<br /> 除了资源选取器提供的日志资源可用性外，还对增量查询和提取文 <a href="../../automating/using/incremental-query.md">件</a><a href="../../automating/using/extract-file.md">活动进行了增强</a> :<br /> 
    <ul> 
     <li> <span class="uicontrol">增量查询</span> 现在允许您使用日期字段检索新数据或更新数据。 以前，先前执行的所有结果都会自动排除，即使它们自上次执行以来已更新。 </li> 
...
* 现在，活动生成的拒 **[!UICONTROL Load file]** 绝文件可在其出站过渡中检索，并在下一个活动中处理。 例如，使用通过SFTP服务器上传拒绝文件 **[!UICONTROL Transfer file]** 。
* 修复了在的选项卡中选择时，用户可能无法限制区段 **[!UICONTROL Temporary resource]** 填充的 **[!UICONTROL General]** 问题 **[!UICONTROL Segmentation]** 。
* **[!UICONTROL Scheduler]** 活动不能再设置为每10分钟多触发一次工作流。
* 修复了可能导致活动 **[!UICONTROL Use common columns]** 无法正常工作的 **[!UICONTROL Union]** 问题。
