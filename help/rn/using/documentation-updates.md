...
现已弃用与Adobe Experience Platform Data Connector和Audience Destinations服务的集成。 [了解更多信息](deprecated-features.md)

详细说明了SMTP测试模式的用法。 [了解更多信息](../../administration/using/configuring-email-channel.md#smtp-test-mode)
