...
新的发布计划文章已发布，以共享即将发布的发行日期。[阅读更多](https://helpx.adobe.com/campaign/kb/acs-release-planning.html)
...
* 添加了一个新部分，其中包含有关为何使用Campaign Standard REST API的通用信息。
* 已提供预先设计的API请求集合，它代表常用用例。
* 新增了如何管理组织单位的新部分。
* 添加了有关如何创建服务的信息。
* 添加了如何使用参数调用工作流的信息。
...
动态报告的指示器计算部分已更新。[阅读更多](../../reporting/using/indicator-calculation.md)

新增了动态报告兼容性表，以更好地了解维度和指标之间的兼容性。[阅读更多](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)

工作流的功能列表已更新。[阅读更多](../../automating/using/list-of-functions.md)

设计内容一章经过重新组织和改进，有一个新的部分说明了不同的方法，用电子邮件设计器使用现有内容设计电子邮件。[阅读更多](../../designing/using/about-email-content-design.md#designing-an-email-using-existing-contents)

新增了有关如何将电子邮件内容另存为电子邮件设计器中的片段的新部分。[阅读更多](../../designing/using/defining-the-email-structure.md#saving-content-as-a-fragment)

“管理链接”部分已更新，包含有关如何在电子邮件设计器中管理跟踪URL的其他信息。[阅读更多](../../designing/using/inserting-a-link.md)

新增了一节以描述特定的交易消息重试过程。[阅读更多](../../channels/using/event-transactional-messages.md#transactional-message-retry-process)

“发布包含API扩展部分的资源”已通过最新UI更改进行了澄清和更新。[阅读更多](../../developing/using/updating-the-database-structure.md#publishing-a-resource-with-api-extension)

存档电子邮件部分已更名并重新组织。[阅读更多](../../administration/using/configuring-email-channel.md#archiving-emails)

创建电子邮件部分已更新，以反映最新的界面更改。[阅读更多](../../channels/using/creating-an-email.md)

[SMS连接器协议和设置](https://helpx.adobe.com/campaign/kb/sms-connector-protocol-and-settings.html) 知识库文章已通过添加到SMS外部帐户的新选项进行更新，以限制允许连接到SMTP提供者的MTA实例数。

快速入门指南已被丰富和重新组织。[阅读更多](../../start/using/campaign-orchestration.md)

已弃用和删除的功能页面已更新。[阅读更多](https://helpx.adobe.com/campaign/kb/acs-deprecated-and-removed-features.html)
...
已添加关于Transactional Messaging限制的新部分。[阅读更多](../../channels/using/about-transactional-messaging.md#transactional-messaging-limitations)

新增了在Adobe Campaign中比较不同电子邮件创作选项的新部分。[阅读更多](../../designing/using/about-email-content-design.md#email-design-options-comparison)

创建自定义内容块部分已得到增强，其中包含定位维度的详细信息。[阅读更多](../../designing/using/adding-a-content-block.md#creating-custom-content-blocks)

系统会添加一条警告，指示电子邮件设计器不支持Internet Explorer11。[阅读更多](../../start/using/compatible-browsers.md)

重新起草的影响已添加到删除资源部分中。[阅读更多](../../developing/using/deleting-a-resource.md)

有关如何添加或扩展资源的章节已更新。[阅读更多](../../developing/using/creating-or-extending-the-resource.md)

添加了如何扩展配置文件自定义资源的用例。[阅读更多](../../developing/using/extending-the-profile-resource-with-a-new-field.md)

添加了有关如何链接自定义资源的信息。[阅读更多](../../developing/using/configuring-the-resource-s-data-structure.md#defining-links-with-other-resources)

添加了一个新的技术说明，用于显示Adobe Campaign Standard推送通知中的图像。[阅读更多](https://helpx.adobe.com/content/help/en/campaign/kb/display-image-push.html)

已添加有关推送跟踪实施的新技术说明。[阅读更多](https://helpx.adobe.com/content/help/en/campaign/kb/push-tracking.html)
...
添加了一个注意事项，在包含这些拒绝的文件名称中添加了时间戳。[阅读更多](../../automating/using/load-file.md#configuration)

在导入由具有固定长度的列组成的字段时添加了信息。[阅读更多](../../automating/using/load-file.md#configuration)

添加了可让您将文件保留在文件中的选项。使用此选项，您现在可以将后处理舞台应用到包含这些拒绝的文件。[阅读更多](../../automating/using/load-file.md#configuration)
...
更新了“用户和安全”章，以反映地理单位的折旧情况。[阅读更多](../../administration/using/organizational-units.md)

新增了有关加载数据活动中的新选项的信息，该选项允许您将后期处理舞台应用于包含被拒绝记录的文件(例如，压缩格式压缩)。[阅读更多](../../automating/using/load-file.md)
...
“设计内容”指南已完全重新组织，特别是演示了允许您设计电子邮件内容的两个编辑器。[阅读更多](../../designing/using/about-email-content-design.md)
...
更新了准备交付的角色定义。[阅读更多](../../administration/using/list-of-roles.md)
...
在“管理”菜单中添加了有关“许可证”选项的信息。[阅读更多](../../administration/using/licenses.md)

添加了有关如何在推送通知中使用自定义字段的信息。[阅读更多](../../channels/using/customizing-a-push-notification.md#add-custom-fields)

更新的交付最佳实践分步指南。[阅读更多](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

添加了有关跟踪日志类型的信息。[阅读更多](../../sending/using/tracking-messages.md#tracking-logs)

查询活动部分已使用查询示例进行更新。[阅读更多](../../automating/using/query.md#query-samples)

专门用于黑名单的部分已更名为“了解参与和选择退出流程”。它已经过更新，可提供有关如何管理特定渠道的选择加入以及如何设置登陆页面以管理参与和选择退出的信息。[阅读更多](../../audiences/using/about-opt-in-and-opt-out-in-campaign.md)

了解使用Adobe托管SFTP服务器的最佳实践。[阅读更多](../../administration/using/external-accounts.md#sftp-external-account)

支持的Analytics SKU列表与触发器的集成已更新。[阅读更多](../../integrating/using/configuring-triggers-in-experience-cloud.md#configuring-solutions-and-services)
...
添加了有关如何设置登陆页面的信息，以便收件人能够列入黑名单。[阅读更多](../../audiences/using/managing-opt-in-and-opt-out-in-campaign.md)

[已重新组织配置交易消息](../../administration/using/configuring-transactional-messaging.md) 部分，并添加了分步 [](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message) 用例。
...
更新了有关Campaign和Adobe解决方案集成的帮助材料列表。[阅读更多](../../integrating/using/about-campaign-integrations.md)信息。
...
添加了关于如何准备分发的分步使用案例。[阅读更多](../../sending/using/preparing-the-send.md)

包括授权列表在内的部分已被删除。[阅读更多](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf) 内容(PDF)。

添加了如何使用SMS自动回复的分步使用案例。[阅读更多](../../channels/using/managing-incoming-sms.md#managing-stop-sms)
...
增加了使用案例，以便更好地了解安全组和单位。[阅读更多](../../administration/using/organizational-units.md)

改进了动态报告中维度、指标和细分的定义和计算。[阅读更多](../../reporting/using/list-of-components-.md)

添加了有关使用工作流检索传入SMS消息的信息。[阅读更多](../../administration/using/configuring-sms-channel.md)

添加了“转移文件活动历史记录”设置的相关信息。[阅读更多](../../automating/using/transfer-file.md)
...
有关移动应用程序发送“收集PII”数据时如何创建或更新配置文件数据的新技术说明。[阅读更多](https://helpx.adobe.com/campaign/kb/acs-updating-profile-based-on-subscription.html)

新增了有关新导出跟踪功能的部分。[阅读更多](../../administration/using/auditing-export-logs.md)

增加了有关现成包导出的精确方法。[阅读更多](../../automating/using/managing-packages.md)

更新了外部帐户定义和示例。[阅读更多](../../administration/using/external-accounts.md)

更新了多个屏幕截图，以反映查询编辑器类别中的更改。
...
专用于主键的新部分以及业务ID在API中的使用。[阅读更多](https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#primary-key)
...
新动态报告视频。[阅读更多](../../start/using/how-to-videos.md)
...
在活动配置文件报告中添加的文档。[阅读更多](../../audiences/using/active-profiles.md)

[交付通知](../../sending/using/receiving-alerts-when-failures-happen.md#delivery-alerting-reasons) 文档已更新，其中含有一个疑难解答部分，介绍了有关接收警报时可采取的操作的几点提示。

提供了新的入门指南：它展示了可用于Adobe Campaign交付的一些最佳实践，从创建和定位到发送和监控。[阅读更多](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_DeliveryBestPractices.html)

后续消息文档已通过改进的用例进行更新。[阅读更多](../../channels/using/follow-up-messages.md#sending-a-follow-up-message)
...
新增的加密和散列函数添加了示例。[阅读更多](../../automating/using/list-of-functions.md)

有关转让文件工作流程活动的更新部分。[阅读更多](../../automating/using/transfer-file.md)
...
报表指示符计算表已更新。[阅读更多](../../reporting/using/indicator-calculation.md)

报表文档已通过四个新指标进行更新。[阅读更多](../../reporting/using/list-of-components-.md)

为配置文件生成的唯一ID生成文档。[阅读更多](../../developing/using/configuring-the-resource-s-data-structure.md#generating-a-unique-id-for-profiles-and-custom-resources)

双击机制现在通过分步步骤记录。[阅读更多](../../channels/using/setting-up-a-double-opt-in-process.md)
...
有关配置People核心服务或Audience Manager与Adobe Campaign的集成的说明已更新。[阅读更多](../../integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)

已修订“授权表”以使特定角色的功能更清晰。[阅读更多](https://docs.campaign.adobe.com/doc/standard/en/Technotes/AdobeCampaign-ACSRights.pdf)
...
关于Adobe Mobile Services配置的新专用部分，用于在Adobe Campaign中使用推送通知和兴趣点数据。[阅读更多](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

更新了移动应用程序配置和实施部分，包括设置和发送推送通知的更多详细步骤。[阅读更多](https://helpx.adobe.com/campaign/kb/configuring-app-sdkv4.html)

更新了有关如何在Campaign中处理图像的部分。[阅读更多](../../designing/using/setting-up-image-properties.md)
