...
隐私权部分已被移动，并且包含了一个新页面： [隐私管理](../../start/using/privacy-management.md)。
...
更新了隐私管理文档中关于如何为自定义用户档案资源创建 CCPA 选择退出字段的信息。[了解更多](https://helpx.adobe.com/content/help/zh-Hans/campaign/kb/acs-privacy.html)
...
创建了关于 Microsoft Dynamics 365 连接器实施和用法的一组新帮助文章。请注意，此功能当前处于“有限可用”状态。[了解更多](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
更新了 Campaign Standard 和 Classic 的错误消息列表。[了解更多](https://docs.campaign.adobe.com/doc/AC/cn/technicalResources/error_messages/error_codes.html)
...
添加了动态报告兼容性表格，以更好地理解维度和指标之间的兼容性。[了解更多](https://docs.campaign.adobe.com/doc/standard/cn/Technotes/dynamic_report_compatibility.pdf)
...
欧盟通用数据保护条例 (GDPR) - [了解更多](https://docs.campaign.adobe.com/doc/standard/getting_started/cn/ACS_GDPR.html)
...
删除了包含授权列表的章节。[了解更多](https://docs.campaign.adobe.com/doc/standard/cn/Technotes/AdobeCampaign-ACSRights.pdf) (PDF)。
