...
在 **[!UICONTROL Extract file]** 工作流活动页面，将数据提取到具有特定编码的CSV文件。 [了解更多信息](../../automating/using/extract-file.md)

## 22.3 版 - 2022 年秋冬 {#release-22-3}

Campaign Standard 22.3 秋/冬版的发行说明已发布。[了解更多信息](release-notes.md)

数据保留期已更新，反映了 22.3 版本中的更改。[了解更多信息](../../administration/using/data-retention.md)
