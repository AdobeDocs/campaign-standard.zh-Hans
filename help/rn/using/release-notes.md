...
![控制面板](assets/do-not-localize/cp-icon.png) **新控制面板版本**. [了解详情](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html?lang=zh-Hans){target=&quot;_blank&quot;}。
