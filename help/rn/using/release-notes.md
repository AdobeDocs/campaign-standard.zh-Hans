...
从 2024 年 6 月 1 日开始，Google 和 Yahoo! 将要求发件人使用一键式 List-Unsubscribe 功能。Campaign 现已支持此功能。可在[此部分](../../administration/using/configuring-email-channel.md#email-channel-parameters)中了解详情。
