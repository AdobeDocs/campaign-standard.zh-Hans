...
# Adobe Campaign Standard帮助 {#using}

+ [产品文档](campaign-standard-home.md)
+ 发行说明 {#release-notes}
   + [发行说明](rn/using/release-notes.md)
   + [2018发行说明](rn/using/release-notes-2018.md)
   + [2017发行说明](rn/using/release-notes-2017.md)
...
+ 入门 {#getting-started}
   + 关于Adobe Campaign {#about-adobe-campaign}
      ...
      + [跟踪、监控和报告](start/using/tracking--monitoring-and-reporting.md)
      + [与Adobe解决方案集成](start/using/integrating-with-adobe-solutions.md)
   + 发现界面 {#discovering-the-interface}
      + [关于界面](start/using/about-the-interface.md)
      + [界面描述](start/using/interface-description.md)
      + [兼容浏览器](start/using/compatible-browsers.md)
   ...
   + 教程 {#tutorials}
      + [分步指南](start/using/step-by-step-guides.md)
      + [操作方法视频](start/using/how-to-videos.md)
+ 档案和受众 {#profiles-and-audiences}
   + [关于档案和受众](audiences/using/about-profiles-and-audiences.md)
   + 管理配置文件 {#managing-profiles}
      + [关于配置文件](audiences/using/about-profiles.md)
      ...
      + [活动配置文件](audiences/using/active-profiles.md)
   ...
   + 管理订阅 {#managing-subscriptions}
      ...
      + [监控订阅](audiences/using/monitoring-subscriptions.md)
   + 了解加入和选择退出流程 {#understanding-opt-in-and-opt-out-processes}
      + [关于Campaign中的选择加入和退出](audiences/using/about-opt-in-and-opt-out-in-campaign.md)
      + [在Campaign中管理选择加入和退出](audiences/using/managing-opt-in-and-opt-out-in-campaign.md)
      + [识别分发的选择退出配置文件](audiences/using/identifying-opt-out-profiles-for-a-delivery.md)
+ 通信渠道 {#communication-channels}
   + 关于通信渠道 {#about-communication-channels}
      + [发现交流渠道](channels/using/discovering-communication-channels.md)
      + [发送消息的主要步骤](channels/using/key-steps-to-send-a-message.md)
   ...
   + SMS消息 {#sms-messages}
      + [关于SMS消息](channels/using/about-sms-messages.md)
      + [创建SMS消息](channels/using/creating-an-sms-message.md)
      + [个性化SMS消息](channels/using/personalizing-sms-messages.md)
   ...
   + 推送通知 {#push-notifications}
      ...
      + [根据移动应用程序数据创建和更新配置文件信息](channels/using/updating-profile-with-mobile-app-data.md)
   ...
   + 直邮 {#direct-mail}
      ...
      + [返回发送方](channels/using/return-to-sender.md)
      + [创建直接邮件](channels/using/creating-the-direct-mail.md)
      + [定义直接邮寄受众](channels/using/defining-the-direct-mail-audience.md)
      + [定义直接邮件内容](channels/using/defining-the-direct-mail-content.md)
      + [工作流中直接邮寄邮件的示例](channels/using/example-of-direct-mail-in-a-workflow.md)
   + 交易消息传递 {#transactional-messaging}
      + [关于交易消息](channels/using/about-transactional-messaging.md)
      + [活动交易消息](channels/using/event-transactional-messages.md)
      + [个人资料信息消息](channels/using/profile-transactional-messages.md)
      + [交易推送通知](channels/using/transactional-push-notifications.md)
      + [跟进消息](channels/using/follow-up-messages.md)
   + 登陆页面 {#landing-pages}
      + [关于登录页面](channels/using/about-landing-pages.md)
      + [登陆页面限制](channels/using/landing-page-limitations.md)
      + [设计登陆页面](channels/using/designing-a-landing-page.md)
      + [共享登陆页面](channels/using/sharing-a-landing-page.md)
      + [数据存储和和解](channels/using/data-storage-and-reconciliation.md)
      + [设置双击过程](channels/using/setting-up-a-double-opt-in-process.md)
+ 设计内容 {#designing-content}
   + 关于内容设计 {#about-content-design}
      + [在Adobe Campaign中设计内容](designing/using/designing-content-in-adobe-campaign.md)
      + [内容设计最佳实践](designing/using/content-design-best-practices.md)
   ...
   + 编辑登陆页面内容 {#editing-landing-page-content}
      + [关于登录页面内容设计](designing/using/about-landing-page-content-design.md)
   ...
   + 编辑SMS和推送内容 {#editing-sms-and-push-content}
      + [关于SMS和推送内容设计](designing/using/about-sms-and-push-content-design.md)
      + [SMS和推送内容编辑器界面](designing/using/sms-and-push-content-editor-interface.md)
   + 加载内容 {#loading-content}
      + [选择现有内容](designing/using/selecting-an-existing-content.md)
      + [从文件导入内容](designing/using/importing-content-from-a-file.md)
      + [从URL导入内容](designing/using/importing-content-from-a-url.md)
      + [使用电子邮件设计器编辑现有内容](designing/using/editing-existing-contents-with-the-email-designer.md)
   + 使用图像 {#using-images}
      + [插入图像](designing/using/inserting-images.md)
      + [设置图像属性](designing/using/setting-up-image-properties.md)
      + [使用Adobe Creative SDK修改图像](designing/using/modifying-images-with-the-adobe-creative-sdk.md)
      + [个性化图像源](designing/using/personalizing-an-image-source.md)
   + 个性化内容 {#personalizing-content}
      + [关于个性化](designing/using/about-personalization.md)
      + [插入个性化字段](designing/using/inserting-a-personalization-field.md)
      + [添加内容块](designing/using/adding-a-content-block.md)
      + [个性化发送方](designing/using/personalizing-the-sender.md)
      + [个性化电子邮件主题行](designing/using/personalizing-the-subject-line-of-an-email.md)
      + [示例：电子邮件个性化](designing/using/example--email-personalization.md)
   + 定义条件内容 {#defining-conditional-content}
      + [定义可见性条件](designing/using/defining-a-visibility-condition.md)
      + [在电子邮件中定义动态内容](designing/using/defining-dynamic-content-in-an-email.md)
      + [在登陆页面中定义动态内容](designing/using/defining-dynamic-content-in-a-landing-page.md)
      + [定义动态文本](designing/using/defining-dynamic-text.md)
   + 管理链接 {#managing-links}
      + [插入链接](designing/using/inserting-a-link.md)
      + [个性化URL](designing/using/personalizing-urls.md)
      + [关于跟踪的URL](designing/using/about-tracked-urls.md)
...
+ 报告 {#reporting}
   ...
   + 报告列表 {#list-of-reports}
      ...
      + [不可交付和弹回](reporting/using/non-deliverables-and-bounces.md)
      + [打开时间](reporting/using/opens.md)
      + [推送通知报告](reporting/using/push-notification-report.md)
      + [SMS报告](reporting/using/sms-report.md)
      + [跟踪指示器](reporting/using/tracking-indicators.md)
      + [取消订阅](reporting/using/unsubscriptions.md)
      + [URL和单击流](reporting/using/urls-and-click-streams.md)
...
+ 与Adobe Cloud集成 {#integrating-with-adobe-cloud}
   ...
   + 使用Campaign和Target {#working-with-campaign-and-target}
      ...
      + [配置Campaign-Target集成](integrating/using/configuring-the-campaign-target-integration.md)
      + [添加Target动态内容](integrating/using/adding-target-dynamic-content.md)
   + 使用Campaign和Analytics {#working-with-campaign-and-analytics}
      + [关于Campaign-Analytics集成](integrating/using/about-campaign-analytics-integration.md)
      + [配置Campaign-Analytics集成](integrating/using/configure-campaign-analytics-integration.md)
      + [Analytics中的营销活动维度和指标](integrating/using/campaign-dimensions-and-metrics-in-analytics.md)
   + 使用Campaign和Audience Manager或People核心服务 {#working-with-campaign-and-audience-manager-or-people-core-service}
      + [关于Campaign-Audience Manager或People核心服务集成](integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)
      + [配置和配置与Audience Manager或People核心服务的集成](integrating/using/provisioning-and-configuring-integration-with-audience-manager-or-people-core-service.md)
      + [疑难解答](integrating/using/troubleshooting.md)
      + [使用Audience Manager或People核心服务共享受众](integrating/using/sharing-audiences-with-audience-manager-or-people-core-service.md)
   + [使用Campaign和Assets核心服务](integrating/using/working-with-campaign-and-assets-core-service.md)
   + 使用适用于移动设备的Campaign和Analytics {#working-with-campaign-and-analytics-for-mobile}
      + [关于Campaign-Point数据整合](integrating/using/about-campaign-points-of-interest-data-integration.md)
      + [配置营销活动点数据集成](integrating/using/configuring-campaign-points-of-interest-data-integration.md)
      + [通过Point of Interest数据个性化营销活动消息](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
   + 使用Campaign和触发器 {#working-with-campaign-and-triggers}
      + [关于Adobe Experience Cloud触发器](integrating/using/about-adobe-experience-cloud-triggers.md)
      + [在Experience Cloud中配置触发器](integrating/using/configuring-triggers-in-experience-cloud.md)
      + [在Campaign中使用触发器](integrating/using/using-triggers-in-campaign.md)
...
+ 管理流程和数据 {#managing-processes-and-data}
   + 关于工作流和数据管理 {#about-workflows-and-data-management}
      + [工作流程数据和流程](automating/using/workflow-data-and-processes.md)
   ...
   + 使用案例：工作流 {#workflow-use-case}
      + [通过补充创建交付](automating/using/workflow-created-query-with-complement.md)
      + [在创建日期创建交付](automating/using/workflow-creation-date-query.md)
      + [创建每周交付](automating/using/workflow-weekly-offer.md)
      + [在位置创建分段](automating/using/workflow-segmentation-location.md)
      + [重定向非Opener](automating/using/workflow-cross-channel-retargeting.md)
+ 开发人员 {#developing}
   ...
   + 添加或扩展资源 {#adding-or-extending-a-resource}
      ...
      + [使用复合标识键调用资源](developing/using/uc-calling-resource-id-key.md)
   + 使用案例：扩展API {#use-case--extending-the-api}
      + [关于扩展API](developing/using/about-extending-the-api.md)
      + [步骤1：将扩展字段添加到配置文件资源](developing/using/step-1--add-extension-fields-to-the-profile-resource.md)
      + [步骤2：发布扩展](developing/using/step-2--publish-the-extension.md)
      + [步骤3：验证扩展](developing/using/step-3--verify-the-extension.md)
   + 使用案例：扩展资源 {#use-cases--extending-resources}
      + [使用新字段扩展配置文件资源](developing/using/extending-the-profile-resource-with-a-new-field.md)
...
+ 管理 {#administrating}
   ...
   + 用户和安全性 {#users-and-security}
      ...
      + [许可证数](administration/using/licenses.md)
   + 配置渠道 {#configuring-channels}
      + [关于频道配置](administration/using/about-channel-configuration.md)
      + [配置电子邮件渠道](administration/using/configuring-email-channel.md)
      + [配置SMS频道](administration/using/configuring-sms-channel.md)
      + [配置移动应用程序](administration/using/configuring-a-mobile-application.md)
      + [配置交易消息](administration/using/configuring-transactional-messaging.md)
   + 使用排版规则 {#working-with-typology-rules}
   ...
   + 应用程序设置 {#application-settings}
      ...
      + [Campaign中的目标映射](administration/using/target-mappings-in-campaign.md)
