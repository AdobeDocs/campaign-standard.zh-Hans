...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> @已列入黑名单/@sent<br /> </td> 
   <td> 速率计算的分母基于已发送计数（已传送+弹回）。<br /> </td> 
  </tr> 
  <tr> 
   <td> 弹回次数+错误<br /> </td> 
   <td> @bounces<br /> </td> 
  ...
  <tr> 
   ...
   <td> @uniqueclicks/@develibed<br /> </td> 
  ...
  <tr> 
   ...
   <td> @unsubscribes/@develibed<br /> </td> 
   <td> 速率计算的分母基于“仅已交付”。<br /> </td> 
  </tr> 
  <tr> 
   <td> 用户未知<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 唯一打开次数<br /> </td> 
   <td> @uniqueopens<br /> </td> 
   <td> 唯一打开是使用唯一RecipientId的ThetaSketch概念计算的。 有关详细信息，请参阅此<a href="https://docs.adobe.com/content/help/en/campaign-standard/using/reporting/about-reporting/troubleshooting.html#unique-open-clicks-no-match">示例</a>。<br /> </td> 
  </tr> 
  <tr> 
   <td> 展示次数<br /> </td> 
   <td> @impess<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 展示次数<br /> </td> 
   <td> @impess<br /> </td> 
   <td> @count(status=视图)或@count（status=button 1单击+按钮2单击+近期）<br /> </td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td> 唯一印象<br /> </td> 
   <td> @uniqueimposs<br /> </td> 
   <td> @unique(@count(status=视图)<br /> </td> 
   <td> 对于<span class="uicontrol">目标用户，根据其活动用户档案(inAppProfile)</span>模板，用户=收件人Id。<br /> 对于 <span class="uicontrol">目标移动应用程序(inAppBroadcast)的所有用户</span> 和 <span class="uicontrol">目标用户，根据其移动用户档案(inApp)模板，</span> 用户= MC Id或等效项，它表示用户、移动应用程序和设备的唯一组合。<br /> </td> 
  </tr> 
  <tr> 
   <td> 应用程序内单击<br /> </td> 
  ...
  <tr> 
   <td> 唯一应用程序内解除<br /> </td> 
   <td> @uniqueccollection<br /> </td> 
   <td> @unique(@count(status=close))<br /> </td> 
   <td> 对于<span class="uicontrol">目标用户，根据其活动用户档案(inAppProfile)</span>模板，用户=收件人Id。<br /> 对于 <span class="uicontrol">目标移动应用程序(inAppBroadcast)的所有用户</span> 和 <span class="uicontrol">目标用户，根据其移动用户档案(inApp)模板，</span> 用户= MC Id或等效项，它表示用户、移动应用程序和设备的唯一组合。<br /> </td> 
  </tr> 
  <tr> 
   <td> 应用程序内解雇率<br /> </td> 
   <td> @unrestalrate<br /> </td> 
