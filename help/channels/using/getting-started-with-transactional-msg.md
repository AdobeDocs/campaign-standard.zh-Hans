...
<td class="noborder"><p>交易消息使您能够 <b>实时向客户发送</b> 个人和独特的消息。<br>它可以是欢迎邮件、订单发运确认、密码修改等。</p></td>
</tr>
</table>
...
* [事件事件](../../channels/using/event-transactional-messages.md)**事务性消息**。<!--The data contained in the event itself is used to define the delivery target.-->
...
* [用户档案事务性消息](../../channels/using/profile-transactional-messages.md)**从Adobe Campaign营销数据库定位用户档案**。<!--You can use information from the Adobe Campaign database to send a transactional message based on customer marketing profiles.-->
...
<td class="noborder"><p>配置将命名为“购物车废弃”的事件并发布此事件配置。</p></td>
</tr>
</table>
...
<td class="noborder"><p>编辑和个性化事务性消息，测试它，然后发布它。</p></td>
</tr>
</table>
...
<td class="noborder"><p>使用REST事务性消息API将事件集成到您的网站中。</p></td>
</tr>
</table>
...
<td class="noborder"><p><br>一旦用户离开网站而不订购购物车中的产品，他们就会自动收到通知电子邮件。</p></td>
</tr>
</table>
