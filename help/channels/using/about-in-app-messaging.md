...
1. 要在Adobe Campaign Standard中将移动用例与Experience CloudSDK应用程序结合使用，必须在数据收集UI中创建移动应用程序，并在Adobe Campaign Standard中进行配置。 有关分步指南，请参阅此[页面](../../administration/using/configuring-a-mobile-application.md)。
