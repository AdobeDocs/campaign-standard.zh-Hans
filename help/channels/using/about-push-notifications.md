...
* **[!UICONTROL Alert/Message/Badge]**&#x200B;类型通知允许您发送包含其他内容（声音、徽章、深层链接等）的标准基于文本的消息 在&#x200B;**[!UICONTROL Advanced options]**&#x200B;部分中定义的附加内容（声音、徽章、深度连接等）。
...
可以设置某些特定配置来定义通知行为。 如需详细信息，请参阅[此小节](../../channels/using/customizing-a-push-notification.md)。
...
1. 要支持移动使用案例实施，请参阅在使用SDK SDK的Adobe Campaign Standard支持的[移动使用案例中有关扩展、标记规则和Adobe Experience Platform实施的详细说明](../../administration/using/configuring-rules-launch.md)。
...
* [视频教程](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/mobile/push/creating-a-push-notification.html?lang=zh-Hans)
