...
1. 在&#x200B;**[!UICONTROL Activities]** > **[!UICONTROL Targeting]**&#x200B;中，若要选择收件人，请拖放[查询](../../automating/using/query.md)活动并双击该活动。
1. 在 **[!UICONTROL Shortcuts]** > **[!UICONTROL Profile]** 中，拖放 **[!UICONTROL Email]**。
1. 选择 **[!UICONTROL is not empty]** 作为运算符。
1. 在 **[!UICONTROL Shortcuts]** > **[!UICONTROL General]** 中，添加轮廓并选择 **[!UICONTROL no longer contact by email]**（其值为 **[!UICONTROL No]**）。
