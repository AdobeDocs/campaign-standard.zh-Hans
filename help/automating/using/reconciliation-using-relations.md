...
* A [調解](../../automating/using/reconciliation.md) 活動，將購買資料繫結至資料庫設定檔及產品。 因此，有必要定义文件数据与用户档案表以及产品表之间的关系。此配置在活动的 **[!UICONTROL Relations]** 选项卡中执行：
...
* 一個 [更新資料](../../automating/using/update-data.md) 活動可讓您定義資料庫欄位，以使用匯入的資料進行更新。 由于数据已在上一活动中被识别为归属&#x200B;**交易**&#x200B;维度，因此您可以在此使用 **[!UICONTROL Directly using the targeting dimension]** 标识选项。
