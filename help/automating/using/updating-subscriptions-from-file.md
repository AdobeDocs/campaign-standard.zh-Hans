...
* A [协调](../../automating/using/reconciliation.md) 活动将文件中的数据标识为属于Adobe Campaign数据库的用户档案维度。 通过 **[!UICONTROL Identification]** 选项卡，将文件的 **email** 字段与用户档案资源的 **email** 字段匹配。
...
* A [订阅服务](../../automating/using/subscription-services.md) 活动将服务标识为通过 **[!UICONTROL Reconciliation]** 活动。
