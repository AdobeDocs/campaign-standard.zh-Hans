...
它们在[目标映射](../../administration/using/target-mappings-in-campaign.md)中配置，并在创建工作流时在“查询”活动的&#x200B;**[!UICONTROL Properties]**&#x200B;选项卡中定义。
...
[此部分](../../automating/using/personalizing-email-with-additional-data.md)中介绍了有关如何使用附加数据个性化电子邮件的用例。
