...
1. 在&#x200B;**[!UICONTROL Activities]** > **[!UICONTROL Execution]**&#x200B;中，拖放[Wait](../../automating/using/wait.md)活动。
...
1. 选择短信模板，然后单击&#x200B;**[!UICONTROL Next]**。
1. 输入短信属性并单击&#x200B;**[!UICONTROL Next]**。
1. 要创建短信的布局，请单击&#x200B;**[!UICONTROL Email Designer]**。
1. 插入元素或选择现有模板。
1. 使用特定于每个位置的选件个性化您的短信。
有关更多信息，请参阅[设计短信](../../channels/using/creating-an-sms-message.md)一节。
1. 单击 **[!UICONTROL Preview]** 以检查布局。
1. 单击 **[!UICONTROL Save]**。
