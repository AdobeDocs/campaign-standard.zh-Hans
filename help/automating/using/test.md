...
1. 定义每个条件的属性：
   ...
   * ![](assets/extsignal_picker.png):从工作流可用的所有变量中选择事件变量(请参阅 [本页](../../automating/using/customizing-workflow-external-parameters.md))。

      例如，您可以检查 [文件传输](../../automating/using/transfer-file.md) 活动 **[!UICONTROL filesCount]** 变量。
