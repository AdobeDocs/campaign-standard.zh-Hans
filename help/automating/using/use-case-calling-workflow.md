...
1. **进行API调用以** 使用外部参数触发工作流1。请参阅[步骤1:配置API调用](../../automating/using/use-case-calling-workflow.md#step-1--configuring-the-api-call)。
...
在配置工作流之前，您需要创建工作流1和2，其中每个工作流中均包含&#x200B;**[!UICONTROL External signal]**&#x200B;活动。 这样，您便能够在调用工作流时定向这些信号活动。
...
1. 添加&#x200B;**[!UICONTROL Transfer file]**&#x200B;活动以将数据导入数据库。要执行此操作，请拖放活动，将其打开，然后选择&#x200B;**[!UICONTROL Protocol]**&#x200B;选项卡。
...
1. 将数据从文件加载到数据库中。
   ...
   要实现此目的，请将&#x200B;**[!UICONTROL Load file]**&#x200B;活动拖放到工作流中，然后根据需要对其进行配置。

1. 使用导入文件中的数据插入并更新数据库。

   为此，请拖放&#x200B;**[!UICONTROL Update data]**&#x200B;活动，然后选择&#x200B;**[!UICONTROL Identification]**&#x200B;选项卡以添加协调条件（在本例中为&#x200B;**email**&#x200B;字段）。

   ![](assets/extsignal_uc3.png)

1. 选择&#x200B;**[!UICONTROL Fields to update]**&#x200B;选项卡，然后指定要在数据库中更新的字段（在本例中为&#x200B;**firstname**&#x200B;和&#x200B;**email**&#x200B;字段）。

   ![](assets/extsignal_uc4.png)

1. 检查是否从文件中检索数据。 为此，请将&#x200B;**[!UICONTROL Test]**&#x200B;活动拖放到工作流中，然后单击&#x200B;**[!UICONTROL Add an element]**&#x200B;按钮以添加条件。
...
1. 如果检索到数据，请将其保存到受众中。 为此，请向&#x200B;**目标不为空**&#x200B;过渡添加&#x200B;**[!UICONTROL Save audience]**&#x200B;活动，然后将其打开。
...
1. 定义要在工作流2中使用的参数及其关联值。
   ...
   在本例中，我们希望传递API调用（**fileToTarget**&#x200B;和&#x200B;**discountDesc**）中最初定义的参数，以及额外的具有常数值(“20% discount”)的&#x200B;**segmentCode**&#x200B;参数。
...
1. 使用在工作流1中保存的受众。 要实现此目的，请将&#x200B;**[!UICONTROL Read audience]**&#x200B;活动拖放到工作流中，然后将其打开。
...
1. 确定消息中要使用的参数，以使用&#x200B;**discountDesc**&#x200B;参数对其进行个性化。 为此，请打开活动的高级选项，然后添加参数名称和值。
