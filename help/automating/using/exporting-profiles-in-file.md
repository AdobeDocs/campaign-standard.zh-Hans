...
1. 拖放 [提取文件](../../automating/using/extract-file.md) 活动，并将其放在 [查询](../../automating/using/query.md) 活动。
...
1. 确认您的活动。
1. 拖放 [传输文件](../../automating/using/transfer-file.md) 活动之后 **[!UICONTROL Extract file]** 活动以在外部帐户上取回提取文件。
