...
### 从 Beta 版过渡到 GA 版{#from-beta-to-ga}
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 正在重试 API URL '%s'，上次尝试失败 ('%s')。</td> 
   <td> <p>正在重试 API URL 'https://example.com/api/v1/web-coupon?count=2'，上次尝试失败 ('HTTP - 401')。</p></td>
  </tr> 
  <tr> 
...
<table> 
 ...
 <tr> 
  ...
  <tr> 
   <td> WKF-560247 - HTTP 标头值错误（标头值：'%s'）。</td> 
