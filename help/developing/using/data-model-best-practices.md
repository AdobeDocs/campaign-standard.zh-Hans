...
以客户为中心的方法如下图所示。 灰色的&#x200B;**用户档案**&#x200B;资源表示正在构建所有内容的主客户表：

![](assets/customer-centric-data-model.png)

此[部分](../../developing/using/datamodel-introduction.md)显示Adobe Campaign默认数据模型。
...
Adobe Campaign自动将[索引](../../developing/using/configuring-the-resource-s-data-structure.md#defining-indexes)添加到资源中定义的所有主键和内部键。
...
在[本节](../../developing/using/configuring-the-resource-s-data-structure.md#defining-links-with-other-resources)中定义与其他资源的链接。
